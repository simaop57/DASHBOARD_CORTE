...
const generateDummyData = () => {
    ...
    for (let i = 0; i < 30; i++) {
        ...
        const [op1, op2] = config.operators; 
        ...
        const newRecord = {
            ...
            // productivity_percent será calculado no renderUI
            operator1: op1, 
            operator2: op2, 
            commissionUnits: commissionUnits,
            totalCommission: totalCommission,
...
const initApp = async () => {
    ...
    // 3. ADICIONA LISTENER PARA O ARQUIVO EXCEL
    ...
    // 4. Carrega a meta da máquina inicial e renderiza a UI (Com dados vazios se o Excel não foi carregado)
    renderUI();
